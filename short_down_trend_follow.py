...
df, stoxx600 = get_df_stoxx(start_bt_date_1yr_plus=start_bt_date_1yr_plus, end_bt_date=end_bt_date)
...
long_signal = long_signal[start_bt_date:]
short_signal =short_signal[start_bt_date:]
...
ew_eq_curve.plot(figsize=(50,100), legend=True) #.loc['2020-08-01':]
